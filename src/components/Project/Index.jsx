    ...
    >
        ...
        <div className="mt-[2vw] w-full sm:flex items-start sm:gap-8 pt-[6vw] sm:pt-0">
          ...
          <div className="thirdCol hidden sm:inline-block relative ">
            <div className={` mainCirclediv ${styles.mainCirclediv} mt-[31vw] ml-[8vw] relative `}>
              <div className={`button relative w-[22vw] h-[22vw] border rounded-full `} data-hover-text="">
                ...
                <div className={`circleIn ${styles.circleIn} absolute w-[100%] h-[100%] scale-0 hover:scale-1 rounded-full flex items-center justify-center top-0 
                  left-0 bg-[#fff] text-[#000]`}
                >
                  <p className={`circleInpara ${styles.circleInpara}  font-[PlinaReg] text-[.9vw] scale-0 w-[70%]`}>We are thrilled to have you on board. We hope you enjoy the projects 🧡</p>
                </div>
              </div>
            </div>
          </div>
