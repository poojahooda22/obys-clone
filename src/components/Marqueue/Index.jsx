        ...
        <div className="page5 w-full h-[100vh] px-[4vw] mt-[3vw] sm:px-[3vw] relative">
            ...
            <div>
              ...
              >
                ...
                <h1 className={`${styles.elemh1} flex items-center gap-[3vw]`}>real estate <div className={`${styles.dash} w-[5vw] h-[.5vw] border-[1px] border-[#fff]`}></div></h1>
                <h1 className={`${styles.elemh1} flex items-center gap-[3vw] font-[silkSerif] `}>architecture <div className={`${styles.dash} w-[5vw] h-[.5vw] border-[1px] border-[#fff]`}></div></h1>
              </div>
              <div className={`elem whitespace-nowrap text-[9.6vw] leading-[12vw] sm:text-[7vw] sm:leading-[7.6vw] flex items-center uppercase font-[PlinaReg] ${styles.elem}`}>
                ...
                <h1 className={`${styles.elemh1} flex items-center gap-[3vw] font-[silkSerif] `}>partners <div className={`${styles.dash} w-[5vw] h-[.5vw] border-[1px] border-[#fff]`}></div></h1>
              ...
              <div className={`elem2 whitespace-nowrap text-[9.6vw] leading-[12vw] sm:text-[7vw] sm:leading-[7.6vw] flex items-center uppercase font-[PlinaReg] ${styles.elem2}`}>
                ...
                <h1 className={`${styles.elemh1} flex items-center gap-[3vw]`}>automotive<div className={`${styles.dash} w-[5vw] h-[.5vw] border-[1px] border-[#fff]`}></div></h1>
                <h1 className={`${styles.elemh1} flex items-center gap-[3vw] font-[silkSerif] `}>hotels <div className={`${styles.dash} w-[5vw] h-[.5vw] border-[1px] border-[#fff]`}></div></h1>
                <h1 className={`${styles.elemh1} flex items-center gap-[3vw]`}>music <div className={`${styles.dash} w-[5vw] h-[.5vw] border-[1px] border-[#fff]`}></div></h1>
                <h1 className={`${styles.elemh1} flex items-center gap-[3vw] font-[silkSerif] `}>automotive<div className={`${styles.dash} w-[5vw] h-[.5vw] border-[1px] border-[#fff]`}></div></h1>
              </div>
            </div>
        </div>
    </div>
